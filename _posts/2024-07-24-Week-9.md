...
- Priority: 
    1. Finish the frame blending example generation process.
    2. Add prompt templates and zero/one/few-shot or CoT options.
    3. Add the function to let LLM find the nearest frames to the user-input word.
